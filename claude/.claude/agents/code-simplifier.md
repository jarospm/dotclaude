...
description: "Code simplicity and YAGNI specialist. Use when reviewing code for unnecessary complexity, over-engineering, premature abstractions, or violations of the 'You Aren't Gonna Need It' principle. Reviews any programming language."
